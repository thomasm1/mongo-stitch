...
// const { mon } = require('../../mo');  //${this.mongo}
// const db = "mongodb://testuser:testpw@ds123136.mlab.com:23136/coinsdb";
const db = `mongodb+srv://thomas:abc123!!@cluster0-dcypd.mongodb.net/test?retryWrites=true&w=majority`;
...
router.get('/memberAltcoins', verifyToken, (req, res) => {
  let memberAltcoins = [
    ,
    {
      "_id": "1",
